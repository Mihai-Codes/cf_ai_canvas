...
- Name: test/diagram-scenarios.spec.ts >> Diagram generation — all three input paths >> Manual prompt: data pipeline generates shapes
- Location: test/diagram-scenarios.spec.ts:236:3
...
- main [ref=e3]:
  - complementary [ref=e4]:
    ...
    - generic [ref=e14]:
      - generic [ref=e15]:
        - strong [ref=e16]: user
        - generic [ref=e17]: Create a data pipeline diagram with source, ingestion, transformation, warehouse, and error handling
      - generic [ref=e18]:
