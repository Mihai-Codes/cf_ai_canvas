...
- Name: test/diagram-scenarios.spec.ts >> Diagram generation — all three input paths >> Quick prompt: Cloudflare Workers AI architecture generates shapes
- Location: test/diagram-scenarios.spec.ts:154:3
...
- main [ref=e3]:
  - complementary [ref=e4]:
    ...
    - generic [ref=e14]:
      - generic [ref=e15]:
        - strong [ref=e16]: user
        - generic [ref=e17]: Create a Cloudflare Workers AI architecture diagram
      - generic [ref=e18]:
