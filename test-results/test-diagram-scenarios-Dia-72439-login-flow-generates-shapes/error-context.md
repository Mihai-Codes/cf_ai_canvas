...
- Name: test/diagram-scenarios.spec.ts >> Diagram generation — all three input paths >> Quick prompt: login flow generates shapes
- Location: test/diagram-scenarios.spec.ts:121:3
...
- main [ref=e3]:
  - complementary [ref=e4]:
    ...
    - generic [ref=e14]:
      - generic [ref=e15]:
        - strong [ref=e16]: user
        - generic [ref=e17]: Draw a login flow with success and error paths
      - generic [ref=e18]:
