...
- Name: test/diagram-scenarios.spec.ts >> Diagram generation — all three input paths >> Manual prompt: microservices diagram generates shapes
- Location: test/diagram-scenarios.spec.ts:208:3
...
- main [ref=e3]:
  - complementary [ref=e4]:
    ...
    - generic [ref=e14]:
      - generic [ref=e15]:
        - strong [ref=e16]: user
        - generic [ref=e17]: Draw a microservices architecture with API gateway, auth service, user service, order service, and database
      - generic [ref=e18]:
